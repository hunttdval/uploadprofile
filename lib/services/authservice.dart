...
class AuthService {
  ...
  signIn(AuthCredential authCreds) async{
    ...
    await FirebaseFirestore.instance
        .collection('manager')
        .doc(user.uid)
        .set({'passCode':'123456','uid':user.uid, 'phone':user.phoneNumber, 'name':'Edit Name', 'image':'https://firebasestorage.googleapis.com/v0/b/phone-login-414b0.appspot.com/o/cofee%20holder.jpg?alt=media&token=696cb718-c9c2-46bc-bbd7-441861295e4a'});
