                  ...
                  children: [
                        ...
                        Align(
                          alignment: Alignment.bottomLeft,
                            child: Card(
                              elevation: 0,
                                child: ListTile(title: Text('SignOut'),onTap: ()async{await _signOutDialog();},leading: Icon(Icons.link_off),enableFeedback: true,)
                            )
                        ),
                        ],
                        );
                ...
                Column(
                  children: [
                    ...
                    StreamBuilder<QuerySnapshot>(
                        stream: firestore.collection('inst').doc('mustOne').collection('items').snapshots(),
                        builder: (context, snapshot) {
                          if (snapshot.hasData) {
                            return Column(
                              children: snapshot.data.docs.map((doc) {
